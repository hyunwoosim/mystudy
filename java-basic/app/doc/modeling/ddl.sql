...
-- 강의배정
DROP TABLE IF EXISTS lms_teacth_lecture RESTRICT;
...
CREATE TABLE lms_lectures (
  ...
  managers_no INTEGER      NULL     COMMENT '매니저번호' -- 매니저번호
)
COMMENT '과정';
...
CREATE TABLE lms_managers (
  managers_no   INTEGER     NOT NULL COMMENT '매니저번호', -- 매니저번호
...
CREATE TABLE lms_teachers (
  teacher_no INTEGER      NOT NULL COMMENT '강사', -- 강사
...
-- 강의배정
CREATE TABLE lms_teacth_lecture (
  lecture_no INTEGER NOT NULL COMMENT '과정번호', -- 과정번호
...
-- 강의배정
ALTER TABLE lms_teacth_lecture
  ADD CONSTRAINT PK_lms_teacth_lecture -- 강의배정 기본키
  PRIMARY KEY (
  lecture_no, -- 과정번호
  teacher_no  -- 강사번호
  );
...
CREATE TABLE lms_members (
  memeber_no  INTEGER     NOT NULL COMMENT '회원번호', -- 회원번호
...
ALTER TABLE lms_members
  MODIFY COLUMN memeber_no INTEGER NOT NULL AUTO_INCREMENT COMMENT '회원번호';
...
-- 강의배정
ALTER TABLE lms_teacth_lecture
  ADD CONSTRAINT FK_lms_teachers_TO_lms_teacth_lecture -- 강사 -> 강의배정
  FOREIGN KEY (
  teacher_no -- 강사번호
  )
...
-- 강의배정
ALTER TABLE lms_teacth_lecture
  ADD CONSTRAINT FK_lms_lectures_TO_lms_teacth_lecture -- 과정 -> 강의배정
  FOREIGN KEY (
  lecture_no -- 과정번호
  )
  REFERENCES lms_lectures ( -- 과정

...
import bitcamp.myapp.controller.assignmet.AssignmentAddController;
import bitcamp.myapp.controller.assignmet.AssignmentDeleteController;
import bitcamp.myapp.controller.assignmet.AssignmentListController;
import bitcamp.myapp.controller.assignmet.AssignmentUpdateController;
import bitcamp.myapp.controller.assignmet.AssignmentViewController;
...
public class DispatcherServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // 페이지 컨트롤러에서 유류가 발생했으면 오류페이졸 포워딩한다.
